...
describe('Like Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'b8baf884-7c93-4f07-a4cc-a45a939df15b' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '0e3fb7f6-934c-459f-97d0-fe1cee3c7d2d' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.likes()[0]).toEqual(expect.objectContaining({ id: 'b8baf884-7c93-4f07-a4cc-a45a939df15b' }));
  });

  describe('trackId', () => {
    it('should forward to likeService', () => {
      const entity = { id: 'b8baf884-7c93-4f07-a4cc-a45a939df15b' };
