...
describe('Comment Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'ccc84bec-d938-436f-87e0-37cc9d637b6c' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '5f137c88-c4d6-4e1c-b302-541b931a6b6d' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.comments()[0]).toEqual(expect.objectContaining({ id: 'ccc84bec-d938-436f-87e0-37cc9d637b6c' }));
  });

  describe('trackId', () => {
    it('should forward to commentService', () => {
      const entity = { id: 'ccc84bec-d938-436f-87e0-37cc9d637b6c' };
