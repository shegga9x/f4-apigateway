package com.f4.gateway.web.rest;

import static com.f4.gateway.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static com.f4.gateway.test.util.OAuth2TestUtil.authenticationToken;
import static com.f4.gateway.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static org.springframework.security.test.web.reactive.server.SecurityMockServerConfigurers.*;

import com.f4.gateway.IntegrationTest;
import com.f4.gateway.security.AuthoritiesConstants;
